 ...
 *
 * This helper computes once at module load and returns the sRGB hex
 * approximation. Reference: https://bottosson.github.io/posts/oklab/
 */
 ...
 * Source-of-truth lives in `app/styles/tokens/colors.css`; the OKLCH
 * coordinates here mirror the design tokens.
 */
